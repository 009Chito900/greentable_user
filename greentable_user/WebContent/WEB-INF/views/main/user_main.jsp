...
<body>
	<div id="wrapper">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item active">
                                <div class="row">
                                    <div class="col-md-3">
                                        <a href="#">
                                            <img src="http://localhost/design_prj/common/images/꿀거봉.gif" alt="Image" style="max-width:100%;">
                                        </a>
                                    </div>
                                    <div class="col-md-3">
                                        <a href="#">
                                            <img src="http://localhost/design_prj/common/images/레몬.gif" alt="Image" style="max-width:100%;">
                                        </a>
                                    </div>
                                    <div class="col-md-3">
                                        <a href="#">
                                            <img src="http://localhost/design_prj/common/images/사과.jpg" alt="Image" style="max-width:100%;">
                                        </a>
                                    </div>
                                    <div class="col-md-3">
                                        <a href="#"> 
                                            <img src="http://localhost/design_prj/common/images/배.png" alt="Image" style="max-width:100%;">
                                        </a>
                                    </div>
                                </div>
                                <!--.row-->
                            ...
                            <div class="carousel-item">
                                <div class="row">
                                    <div class="col-md-3">
                                        <a href="#">
                                            <img src="http://localhost/design_prj/common/images/전복.jpg" alt="Image" style="max-width:300px; height: 304px">
                                        </a>
                                    </div>
                                    <div class="col-md-3">
                                        <a href="#">
                                            <img src="http://localhost/design_prj/common/images/연어.jpg" alt="Image" style="max-width:100%;">
                                        </a>
                                    </div>
                                    <div class="col-md-3">
                                        <a href="#">
                                            <img src="http://localhost/design_prj/common/images/순살고등어.png" alt="Image" style="max-width:300px; height: 304px">
                                        </a>
                                    </div>
                                    <div class="col-md-3">
                                        <a href="#">
                                            <img src="http://localhost/design_prj/common/images/오곡밥.png" alt="Image" style="max-width:300px; height: 304px">
                                        </a>
                                    </div> 
                                </div>
                                <!--.row-->
		...
		<div id="footerMenuDiv">
			<a href="user_menu1.jsp"><img src="http://localhost/design_prj/common/images/menu1.png" class="menu_img" height="400px"/></a>
			<div id="footerMenuTxt1"> 과수원</div>
			<a href="user_menu2.jsp"><img src="http://localhost/design_prj/common/images/menu2.png" class="menu_img" height="400px"/></a>
			<div id="footerMenuTxt2"> 쌀 잡곡</div>
			<a href="user_menu3.jsp"><img src="http://localhost/design_prj/common/images/menu3.png" class="menu_img" height="400px"/></a>
			<div id="footerMenuTxt3"> 바다와 강</div>
		</div>

		<button type="button" class="btn btn-outline-dark" id="upBtn" style="float: right; margin-right: 20px">TOP</button>
