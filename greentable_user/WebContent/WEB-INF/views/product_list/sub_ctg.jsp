...
<body>
	...
	<img src="common/images/fish1.png">
		...
		<div id="container">
			...
			<div align="center" style="margin-bottom: 70px">
	           ...
	           <button class="btn btn-outline-success filter-button" data-filter="sprinkle" style="float:left; margin-left: 100px">전체보기</button>
	            <c:forEach var="scl" items="${ subCtgNameList }" >
	         <form id="frm" action="sub_ctg.do?sub_flag=${scl.sub_ctg_nick}" style="float: left">
	            <button id="subCtgBtn" class="btn btn-outline-success filter-button" data-filter="sprinkle">${ scl.sub_ctg_name }</button>
	       ${scl.sub_ctg_nick}
	        </form>   
	            </c:forEach>
	        </div>
			...
			<c:forEach var="scl"  items="${s_ctg_pl_list }" varStatus="status">

				<div class="card" style="width: 380px; display: inline-block">
					<img class="card-img-top" src="upload/${scl.pro_img_thumb}" alt="Card image"
						style="width: 100% ; height:350px">
					<div class="card-body">
						<h4 class="card-title"><c:out value="${scl.product_name }"/></h4>
						<p class="card-text"><c:out value="${scl.pro_text_info }"/></p>
						<h5 class="card-text" style="color: #FB0000"><c:out value="${scl.option_price }"/>원</h5>
